...
{
	public static class ResourcesPathConfig
	{
		public static class Core
		{
			public static readonly string GameFramework = "Assets/AssetsPackage/Core/GameFramework.prefab";
			public static readonly string Rewired = "Assets/AssetsPackage/Core/Rewired.prefab";
		}
